...
@rem tcc32.exe %INC% ..\tinycc\tcc.c -o tcc32_1.exe
..\bin_win32\tcc.exe ..\tinycc\tcc.c -o tcc32_1.exe -I ..\include -I ..\include\winapi
tcc32_1.exe %INC% ..\tinycc\tcc.c -o tcc32_2.exe
tcc32_2.exe %INC% ..\tinycc\tcc.c -o tcc32_3.exe

@rem set CC=tcc32.exe
set CC=..\bin_win32\tcc.exe
