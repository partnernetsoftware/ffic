        ...
        case 19:
            {
                ...
                if (memcmp (ptr-4, expect, sizeof(expect)) == 0) {
                    ...
                    Section *sec;
                    int32_t x;
                    __builtin___memcpy_chk (ptr-4, replace, sizeof(replace), __builtin_object_size (ptr-4, 0));
        ...
        case 20:
            {
                ...
                if (memcmp (ptr-3, expect, sizeof(expect)) == 0) {
                    __builtin___memcpy_chk (ptr-3, replace, sizeof(replace), __builtin_object_size (ptr-3, 0));
                    rel[1].r_info = ((((Elf64_Xword) (0)) << 32) + (0));
                }
                else
